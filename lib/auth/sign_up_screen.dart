...
class SignUpScreen extends StatelessWidget {
  ...
  pushRegister(final XController x) async {
    ...
    try {
      ...
      final response = await x.provider.pushResponse('api/checkEmailPhone', jsonEncode(datapush));
    ...
    try {
      ...
      final response = await x.provider.pushResponse('api/register', jsonEncode(datapush));
      //debugPrint(response);
