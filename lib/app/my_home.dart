...
import 'package:homerental/screens/addProperty_screen.dart';
...
class MyHome extends StatelessWidget {
  final ProfileScreen profileScreen = Get.put(ProfileScreen());
          ...
          child: Scaffold(
            ...
            bottomNavigationBar: Obx(
              () => DotNavigationBar(
                ...
                marginR: const EdgeInsets.symmetric(horizontal: 22, vertical: 0),
  ...
  final _channel = const MethodChannel('com.manal.secondHome/app_retain');
  ...
  //static function
  static pushLikeOrDislike(final XController x, final RentalModel rental, final bool isLiked) {
    if (isLiked) {
  ...
  static showDialogInputReview(final XController x, final RentalModel rental, final UserModel user) {
    _noteReview.text = '';
