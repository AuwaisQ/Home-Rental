...
class HomeScreen extends StatelessWidget {
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.only(top: 10, left: 3, right: 5, bottom: 5),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${myPref.pCurrency.val} ${MyTheme.formatCounterNumber(e.price!)}/Month",
                                      style: const TextStyle(
                                          fontSize: 14,
                                          color: Colors.deepOrange,
                                          fontWeight: FontWeight.w700),
  ...
  static Widget listNearbyMap(final MyPref myPref, final List<RentalModel> latests, final Function(int index) onTap) {
