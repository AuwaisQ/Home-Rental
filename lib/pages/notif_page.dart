      ...
      child: Column(
        ...
        children: notifs.map((NotifModel e) {
          ...
          return Material(
            ...
            child: InkWell(
              onTap: () async {
                final callback = await MyHome.showDialogNotif(XController.to, e);
                debugPrint(callback);
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("${e.title}", style: textBold.copyWith(fontSize: 14)),
                      Text("${e.description}",
                        maxLines: 5,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                onPressed: () async {
                                  launchUrlString('tel:+91${e.flag}');
                                },
                                icon: const Icon(FontAwesome.phone, size: 18, color: MyTheme.iconColor)),
                          ],
                        ),
                      )
                    ],
