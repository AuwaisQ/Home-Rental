...
class DashChatState extends State<DashChat> {
  ...
  Widget build(BuildContext context) {
    final scrollToBottomWidget =
        widget.scrollToBottomStyle ?? ScrollToBottomStyle();
          ...
          child: Stack(
            children: <Widget>[
              ...
              if (visible && !_initialLoad)
                Positioned(
                  right: scrollToBottomWidget.right,
                  left: scrollToBottomWidget.left,
                  bottom: scrollToBottomWidget.bottom,
                  top: scrollToBottomWidget.top,
                  child: widget.scrollToBottomWidget != null
                      ? widget.scrollToBottomWidget!()
                      : ScrollToBottom(
                          onScrollToBottomPress: widget.onScrollToBottomPress,
                          scrollToBottomStyle: scrollToBottomWidget,
